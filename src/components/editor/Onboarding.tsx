...
const STEPS: OnboardingStep[] = [
  ...
  {
    title: 'AI Editing Agent ✨',
    description: 'Describe edits in plain English and let Google\'s Gemini translate them into real editor operations. Look for the floating ✨ button at the bottom-left of the screen.',
    icon: <Sparkles size={48} className="text-sky-400" />,
    tips: [
      'Click the ✨ bubble (bottom-left) to open the agent panel',
      'Try: "make it grayscale", "draw a red circle", "fill the background blue"',
      'Edits appear as a preview — Accept to commit, Reject to discard',
      'Your Gemini API key stays in browser memory only (never persisted)',
      '14 tools: filters, develop, selection, drawing, text, bucket fill',
    ],
  },
  {
