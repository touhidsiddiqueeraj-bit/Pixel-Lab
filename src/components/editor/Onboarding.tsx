...
const STEPS: OnboardingStep[] = [
  ...
  {
    title: 'Luna — AI Editing Assistant ✨',
    description: 'Describe edits in plain English and let Google\'s Gemini translate them into real editor operations. Look for the floating ✨ button at the bottom-right of the screen.',
    icon: <Sparkles size={48} className="text-sky-400" />,
    tips: [
      'Click the ✨ bubble (bottom-right) to open Luna',
