...
| Doc | What it covers |
|---|---|
| [**Architecture**](ARCHITECTURE.md) | System design, data flow diagrams, canvas rendering engine, AI agent loop, performance system, extension points |
| [**Contributing**](CONTRIBUTING.md) | Dev setup, coding standards, how to add new tools / filters / agent tools, PR process, test scripts |
| [**Security Notes**](SECURITY_NOTES.md) | Honest disclosure of AI agent API key handling — what's safe, what isn't, what you can do |
